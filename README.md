...
13. Troubleshoot:
a. Container won't run due to x86/arm64 issue, refer to Docker installation/configuration section
b. Exception from step 9. Try step 11 and see if you can run queries, you can init your database from this way (the hard way)
c. Updating SQL_SERVER_CREATE.sql and other queries won't update my database. 
